...
author: "William Imoh"
meta_description: "Deliver larger parcels using Porterbuddy's Quite Big Box product."
---
...
<ContentCallout title={"Samlevert not supported 🚨"}>QBB orders are currently ineligible for Samlevert. i.e They cannot be consolidated with normal delivery orders.</ContentCallout> 

## Activating QBB
To activate Quite Big Box, contact your key account manager, requesting to enable the product on your account.

## Current plugin support
The QBB product is currently supported in the followi ng Porterbuddy plugins:
