...
<ContentCallout title={"Samlevert not supported 🚨"}>PL orders are currently ineligible for Samlevert. i.e They cannot be consolidated with normal delivery orders.</ContentCallout> 
