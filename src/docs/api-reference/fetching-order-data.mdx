...
| pickupAddress             | [Resolved Address](https://developer.porterbuddy.com/#resolved-address) | Specified origin address for the order, usually the retailer's warehouse address                                                         |
| destinationAddress        | [Resolved Address](https://developer.porterbuddy.com/#resolved-address) | Destination address for the order (recipient address)                                                                                    |
...
| parcels                   | List<[Parcel](https://developer.porterbuddy.com/#parcel)>               | Current parcel specification                                                                                                             |
| verifications             | [Verifications](https://developer.porterbuddy.com/#verifications)       | Verifications to perform on delivery                                                                                                     |
